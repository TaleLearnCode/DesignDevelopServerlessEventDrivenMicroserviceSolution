...
GO
EXEC sp_addextendedproperty @level0name=N'Product', @level1name=N'Product', @level2name=N'Price',       @value=N'The current price for the product.',                                         @name=N'MS_Description', @level0type=N'SCHEMA', @level1type=N'TABLE', @level2type=N'COLUMN';
GO
