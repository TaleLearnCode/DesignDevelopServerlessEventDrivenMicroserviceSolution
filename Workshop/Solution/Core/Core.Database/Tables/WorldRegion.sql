...
GO
EXEC sp_addextendedproperty @level0name = N'Core', @level1name = N'WorldRegion', @level2name = N'IsActive',                  @value = N'Flag indicating whether the world region is active.',                                 @name = N'MS_Description', @level0type = N'SCHEMA', @level1type = N'TABLE', @level2type = N'COLUMN';
GO
EXEC sp_addextendedproperty @level0name = N'Core', @level1name = N'WorldRegion', @level2name = N'pkcWorldRegion',            @value = N'Defines the relationship between the WorldRegion and WorldRegion tables.',            @name = N'MS_Description', @level0type = N'SCHEMA', @level1type = N'TABLE', @level2type = N'CONSTRAINT';
GO
EXEC sp_addextendedproperty @level0name = N'Core', @level1name = N'WorldRegion', @level2name = N'fkWorldRegion_WorldRegion', @value = N'Defines the primary key for the WorldRegion table.',                                  @name = N'MS_Description', @level0type = N'SCHEMA', @level1type = N'TABLE', @level2type = N'CONSTRAINT';
GO
